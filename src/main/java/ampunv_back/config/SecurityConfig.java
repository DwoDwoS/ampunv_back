...
import ampunv_back.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/furnitures", "/api/furnitures/{id}").permitAll()
                        .requestMatchers("/api/images/furniture/**").permitAll()
                        ...
                        .requestMatchers("/api/users/me", "/api/cart/**").authenticated()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://ampunv.vercel.app/"));
